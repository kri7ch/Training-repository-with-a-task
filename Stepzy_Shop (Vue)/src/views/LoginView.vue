<template>
  <div class="login">
    ...
    <form @submit.prevent="handleLogin">
      ...
      <button type="submit" class="btn btn-black" style="width: 100%;">Войти</button>
      <p style="margin-top: 15px; text-align: center;">
        Нет аккаунта? <router-link to="/register" style="text-decoration: underline;">Зарегистрироваться</router-link>
      </p>
    </form>
  </div>
</template>
